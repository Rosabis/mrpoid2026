...
public final class MrpoidMain {
	static final String TAG = MrpoidMain.class.getSimpleName();
	...
	public static void init1(Context context) {
		EmuLog.d(TAG, "EmulatorApplication create! pid=" + Process.myPid());
	...
	public static void runMrp(final Activity context, final String mrpPath, int defProcIndex, boolean force) {
		...
		manager.requestIdleProcess(defProcIndex, force, mrpPath, new RequestCallback() {
